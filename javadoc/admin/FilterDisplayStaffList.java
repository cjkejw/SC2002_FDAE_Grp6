...
/**
 * This is a class for filtering and displaying staff lists based on different criteria
 */
public class FilterDisplayStaffList implements BranchInterface {
	...
	private void displayStaffListRole(String role, Hashtable<String, Person> personTable) {
		if (role.equals("M")) {
	...
	/**
	 * This method allows the admin to choose the filtering criteria for displaying the staff list
	...
	/**
	 * This method allows the admin to choose the branch 
